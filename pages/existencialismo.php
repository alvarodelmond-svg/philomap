...
<body>
    ...
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-group">
                ...
                <ul class="nav-list collapsible-content" id="conceptsList">
                    ...
                    <li class="nav-item"><a href="existencialismo.html" class="active">Existencialismo</a></li>
        ...
        <main class="main-content">
            ...
            <div class="breadcrumbs"><a href="../index.html">Início</a> / <span>Existencialismo</span></div>
