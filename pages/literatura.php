    ...
    <div class="app-container">
        ...
        <aside class="sidebar" role="navigation">
            <a href="../index.html" class="sidebar-logo">
                <img src="../assets/img/logo-site.svg" alt="PhiloMap Logo" class="logo-header" width="280" height="280" loading="lazy" width="1200" height="800">
            </a>
            ...
            <nav class="nav-group">
                ...
                <ul class="nav-list">
                    <li class="nav-item"><a href="literatura.html" class="active">Literatura</a></li>
                </ul>
            </nav>
        ...
        <main class="main-content" id="main-content" role="main">
            <div class="breadcrumbs"><a href="../index.html">Início</a> / <span>Literatura Filosófica</span></div>
